...
<div class="soubg">
	<div class="sou">
    	<!--Begin 所在收货地区 Begin-->
    	<span class="s_city_b">
        	<span class="fl">${param.xxx}送货至：</span>
            <span class="s_city">
            	<span>四川</span>
                <div class="s_city_bg">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，欢迎 ${user.username}&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="search">
    	<form action="searchServlet">
        	<input type="text" name="searchWords" value="" class="s_ipt" />
