...
2. @include   静态调用
区别：
a. 	第一种方式，引用的jsp生成的Servlet是直接调用被引用的jsp(header.jsp)内容
   	第二种方式，引用的jsp生成的Servlet直接把被引用的jsp(header.jsp)内容加进来
b.  第一种方式可以传参数给被引用的jsp(header.jsp)
    	...
    	<div class="l_history">
        	...
        	<ul>
        		<c:forEach items="${glist}" var="g">
        			<li>
	                    <div class="img"><a href="#"><img src="${g.imgPath }" width="185" height="162" /></a></div>
	                	<div class="name"><a href="#">${g.goodsDesc}</a></div>
	                    <div class="price">
	                    	<font>￥<span>
	                    		<fmt:formatNumber value="${g.price}" pattern="#,##0.00"></fmt:formatNumber>
	                    	</span></font>
	                    </div>
	                </li>
        		</c:forEach>
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <c:forEach items="${glist}" var="g">
	                ...
	                <li>
                    	<div class="img"><a href="#"><img src="${g.imgPath }" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span>
                            	<fmt:formatNumber value="${g.price}" pattern="#,##0.00"></fmt:formatNumber>
                            </span></font>
